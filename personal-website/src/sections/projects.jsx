            ...
            <section id="projects">
                ...
                <div className="row">
                    <div id="portfolio-wrapper" className="bgrid-quarters s-bgrid-thirds cf">
                        <div className="columns collapsed portfolio-item">
                                ...
                                <a href="#modal-01">
                                    ...
                                    <div className="overlay">
                                        <div className="portfolio-item-meta">
                                            ...
                                            <p>This is the second iteration of my personal website. First version used basic html and css, while my primary focus on this version was to develop through React.</p>
                                        </div>
                                    </div>
                                </a>
                            </div>
                                ...
                                <a href="#modal-01">
                                    ...
                                    <div className="overlay">
                                        <div className="portfolio-item-meta">
                                            ...
                                            <p>I'm undertaking the totality of the coding and script-writing process for the development of a game. Freelancing for the art and other assets.</p>
                                        </div>
                                    </div>
                                </a>
                            </div>
                                ...
                                <a href="#modal-01">
                                    ...
                                    <div className="overlay">
                                        <div className="portfolio-item-meta">
                                            ...
                                            <p>A music editor made using the Model-View-Controller pattern and object-oriented practices.</p>
                                        </div>
                                    </div>
                                </a>
                            </div>
                                ...
                                <a href="#modal-01">
                                    ...
                                    <div className="overlay">
                                        <div className="portfolio-item-meta">
                                            ...
                                            <p>Sample website created to learn React. Can interact with a database and deals with several CRUD permissions.</p>
                                        </div>
                                    </div>
                                </a>
                            </div>
                            ...
                            <div className="item-wrap">
                                <a href="#modal-01">
                                    ...
                                    <div className="overlay">
                                        <div className="portfolio-item-meta">
                                            <h5>Unix Shell (C)</h5>
                                            <p>A bash implementation that supports command line operations like piping and redirects.</p>
                                        </div>
                                    </div>
                                </a>
                            </div>
                                ...
                                <a href="#modal-01">
                                    ...
                                    <div className="overlay">
                                        <div className="portfolio-item-meta">
                                            ...
                                            <p>An updated retirement calculator made for the MSRB. Main goal was to simplify the experience for the user as much as possible. Worked on both the front-end and back-end.</p>
                                        </div>
                                    </div>
                                </a>
                            </div>
                                ...
                                <a href="#modal-01">
                                    ...
                                    <div className="overlay">
                                        <div className="portfolio-item-meta">
                                            ...
                                            <p>A dynamic and fast memory allocator to emulate the behavior of malloc in the C library.</p>
                                        </div>
                                    </div>
                                </a>
                            </div>
                                ...
                                <a href="#modal-01">
                                    ...
                                    <div className="overlay">
                                        <div className="portfolio-item-meta">
                                            ...
                                            <p>Simulates data interaction of a mock aquarium. Allows a user to manipulate the data and learn about the relationships between the various interconnecting entities.</p>
                                        </div>
                                    </div>
                                </a>
                            </div>
                                ...
                                <a href="#modal-01">
                                    ...
                                    <div className="overlay">
                                        <div className="portfolio-item-meta">
                                            ...
                                            <p>A file system created from FUSE API. Can create files, directories, hard links, and perform simple file system commands.</p>
                                        </div>
                                    </div>
                                </a>
                            </div>
                ...
                <p>*Note: Some of my projects on github were requested by those I worked with to be private. Can be made public upon request.</p>
            </section>
        );
    }
}
